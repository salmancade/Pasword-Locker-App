...
def main():
    while True:
        ...
        print('\n')
        print(
            "Select a short code to navigate through:to create new user use 'nu':To login to your account 'lg' or 'ex' to exit the system")
                    ...
                    if option == '2':
                        while True:
                            ...
                            if choice == 'y':
                                ...
                                print("Enter password")
                                print(
                                    "To generate random password enter key word 'rp' or 'cp' to create your own password")
                                keyword = input().lower()
